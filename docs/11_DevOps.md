...
### Статус рабочего ПК (HQ3381) — 2026-05-09
...
| research/.env | ⏳ не создан | шаг 5 bootstrap — нужны GP creds + Firebase key |
| pre-commit hook | ⏳ не активирован | `git config core.hooksPath ops/hooks` |
